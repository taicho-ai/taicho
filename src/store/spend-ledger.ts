...
export interface SpendLedger {
  /** Undefined ⇒ this scope has no ceiling and the loop skips it (zero DB reads). */
...
/** `[budget exhausted]` with no attribution is a support ticket. Name the scope that tripped. */
